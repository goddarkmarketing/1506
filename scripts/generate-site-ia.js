...
<link rel="stylesheet" href="${rel(depth, "css/dg-mobile.css")}?v=6" />
`.trim();
...
function ctaDockHtml(depth) {
  const home = pageHref("/", depth);
  const quote = pageHref("/proposal/", depth);
  return `<nav class="dg-cta-dock" aria-label="Quick contact">
  <ul class="dg-cta-dock__list">
    <li class="dg-cta-dock__item" data-dock="line">
    ...
    <li class="dg-cta-dock__item" data-dock="wa">
    ...
    <li class="dg-cta-dock__item is-active" data-dock="home">
    ...
    <li class="dg-cta-dock__item" data-dock="quote">
      <a href="${quote}" aria-label="Quote">
    ...
    <li class="dg-cta-dock__item" data-dock="call">
...
${footerHtml(depth)}
${lucideBootstrap()}
<script src="${rel(depth, "js/dg-cta-dock.js")}" defer></script>
<script>
${megaInitScript()}
</script>
${extraScript}
...
if (!index.includes("dg-mobile.css")) {
  index = index.replace(
    ...
    '$1<link rel="stylesheet" href="css/dg-mobile.css?v=7" />'
  );
} else {
  index = index.replace(/dg-mobile\.css\?v=\d+/g, "dg-mobile.css?v=7");
}
