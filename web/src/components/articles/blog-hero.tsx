    ...
    <section className="relative -mt-[108px] flex min-h-[360px] items-end overflow-hidden pt-[108px] text-white">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-12 pt-16 lg:px-8 lg:pb-14">
        ...
        <motion.h1
          ...
          className="font-display mt-3 whitespace-nowrap text-[clamp(1.35rem,3.4vw,2.75rem)] font-semibold tracking-tight"
        >
          คู่มือท่องเที่ยว แรงบันดาลใจ และเคล็ดลับการเดินทาง
        </motion.h1>
      </div>
    </section>
  );
